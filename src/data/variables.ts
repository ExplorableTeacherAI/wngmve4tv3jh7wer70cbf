...
export const variableDefinitions: Record<string, VariableDefinition> = {
    ...
    inverseCandidateA: {
        defaultValue: 1,
        type: 'number',
        label: 'Your matrix, entry a',
        description: 'Top-left entry of the matrix the student is testing as an inverse',
        min: -2,
        max: 2,
        step: 0.5,
        color: '#62D0AD',
    ...
    inverseCandidateB: {
        defaultValue: 0,
        type: 'number',
        label: 'Your matrix, entry b',
        description: 'Top-right entry of the matrix the student is testing as an inverse',
        min: -2,
        max: 2,
        step: 0.5,
        color: '#62D0AD',
    ...
    inverseCandidateC: {
        defaultValue: 0,
        type: 'number',
        label: 'Your matrix, entry c',
        description: 'Bottom-left entry of the matrix the student is testing as an inverse',
        min: -2,
        max: 2,
        step: 0.5,
        color: '#62D0AD',
    ...
    inverseCandidateD: {
        defaultValue: 1,
        type: 'number',
        label: 'Your matrix, entry d',
        description: 'Bottom-right entry of the matrix the student is testing as an inverse',
        min: -2,
        max: 2,
        step: 0.5,
        color: '#62D0AD',
    ...
    inverseMatchCount: {
        ...
        description: 'How many of the four product entries already match the identity matrix',
        min: 0,
        max: 4,
        step: 1,
        color: '#22c55e',
    ...
    // ─────────────────────────────────────────
    practiceEntryPosition: {
        defaultValue: 'row 1, column 1',
        type: 'select',
        label: 'Practice: which entry',
        description: 'Which square of the product the student is asked to work out',
        options: ['row 1, column 1', 'row 1, column 2', 'row 2, column 1', 'row 2, column 2'],
        color: '#AC8BF9',
        bgColor: 'rgba(172, 139, 249, 0.15)',
    },
    answerPracticeGridTopLeft: {
        defaultValue: '',
        type: 'select',
        label: 'Practice: row 1, column 1',
        description: 'Student answer for the row 1, column 1 entry of C times D',
        placeholder: '???',
        correctAnswer: '8',
        options: ['3', '8', '11', '12'],
        color: '#8E90F5',
    },
    answerPracticeGridTopRight: {
        defaultValue: '',
        type: 'select',
        label: 'Practice: row 1, column 2',
        description: 'Student answer for the row 1, column 2 entry of C times D',
        placeholder: '???',
        correctAnswer: '11',
        options: ['3', '8', '11', '12'],
        color: '#8E90F5',
    },
    answerPracticeGridBottomLeft: {
        defaultValue: '',
        type: 'select',
        label: 'Practice: row 2, column 1',
        description: 'Student answer for the row 2, column 1 entry of C times D',
        placeholder: '???',
        correctAnswer: '12',
        options: ['3', '8', '11', '12'],
        color: '#8E90F5',
    },
    answerPracticeGridBottomRight: {
        defaultValue: '',
        type: 'select',
        label: 'Practice: row 2, column 2',
        description: 'Student answer for the row 2, column 2 entry of C times D',
        placeholder: '???',
        correctAnswer: '3',
        options: ['3', '8', '11', '12'],
        color: '#8E90F5',
